...
public final class J3DLetterBranchGroup extends AbstractLetterBranchGroup
{
  ...
  static
  {
    final Map<java.awt.font.TextAttribute, Object> map = 
      new HashMap<java.awt.font.TextAttribute, Object> ();
    map.put (java.awt.font.TextAttribute.FOREGROUND, new java.awt.Color (0, 0,
        0));
    ...
    J3DLetterBranchGroup.fontLetter3d = new Font3D (
        (Font)AbstractLetterBranchGroup.getFontLetter (), new FontExtrusion ());
  }
  ...
  public J3DLetterBranchGroup (final Object branchgroup)
  {
    ...
    tg = (TransformGroup) ((J3DTransformGroup) this
        .getTransformGroup ()).getImpl ();
  ...
  public void affectLetter (final char letter1)
  {
    ...
    final Text3D textGeom = new Text3D (J3DLetterBranchGroup.fontLetter3d, ""
        + letter1, new Point3f ((float) -0.65, (float) 0.5, (float) 0.025));
  ...
  {
    final int trois = 3;
    final String subclass = this.getClass ().getSimpleName ().substring (trois);
  ...
  public void setPoints (final int points)
  {
    ...
    scale3D.mul (rot);
    final Text3D textGeom = new Text3D (J3DLetterBranchGroup.fontLetter3d, ""
        + points, new Point3f ((float) -0.25, (float) 0.2, (float) 0.18));
    final Shape3D text = new Shape3D ();
    final Appearance appearance = new Appearance ();
    final Material material = new Material ();
    appearance.setMaterial (material);
