...
public final class ChangeTurnBean extends AbstractUIBean
{
  ...
  /**
   * @param letterBranchGroups1 the letterBranchGroups to set
   */
  ...
  /**
   * @param letterPositions1 the letterPositions to set
   */
  public void setLetterPositions 
  (final double [] letterPositions1)
  {
