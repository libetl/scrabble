...
public class ListenerTagParser implements TagParser
{
  ...
  public final void parse (final UserInteractions ui,
    ...
    if (atts.getValue (UIConstants.EVENT_ATTRIBUTE) != null)
    {
      ...
      final int instanceId = interaction.createInstance (atts
          .getValue (UIConstants.ID_ATTRIBUTE), atts
          .getValue (UIConstants.TYPE_ATTRIBUTE));
      interaction.addEvent (instanceId, atts
          .getValue (UIConstants.EVENT_ATTRIBUTE), atts
          .getValue (UIConstants.METHOD_ATTRIBUTE));
    } else if (atts.getValue (UIConstants.EVENTS_ATTRIBUTE) != null)
    {
      ...
      {
        interaction.addEvent (instanceId, event.trim (), atts
            .getValue (UIConstants.METHOD_ATTRIBUTE));
      }
    }
  }
