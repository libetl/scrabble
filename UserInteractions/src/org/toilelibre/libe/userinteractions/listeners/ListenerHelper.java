...
public final class ListenerHelper
{
  ...
  private static void doRedirect (final ActionRedirect ar, final IUIBean bean,
      final EventObject e) throws UIException
  {
      ...
      final String event, final Action action, final Method m)
  {
    ...
    ListenerHelper.LOG.debug (e.getSource ().getClass ().getSimpleName ()
        + " \"" + sourceName + "\" {" + type + UIConstants.PACKAGE_SEPARATOR
        + event + " () => " + action.getClass ().getSimpleName ()
