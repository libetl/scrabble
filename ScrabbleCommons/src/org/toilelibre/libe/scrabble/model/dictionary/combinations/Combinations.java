...
public final class Combinations
{
  ...
  private static List<String> getCombinaisons (final String word, final int num)
  {
      ...
      final int num, final String debutMot)
  {
    ...
    {
      combinaison = new LinkedList<String> ();
      final List<String> la = Combinations.getCombinaisons (word.substring (1),
          num - 1, debutMot + word.charAt (0));
      final List<String> lb = Combinations.getCombinaisons (word.substring (1),
          num, debutMot);
      if (la != null)
      {
