...
public class LettersXmlContentHandler implements ContentHandler
{
   ...
   * 
   * @throws SAXException
   *           en cas de probleme quelquonque ne permettant pas de considerer
   *           l'analyse du document comme etant complete.
   ...
   * espaces se succedant, les tabulations, et les retours chariot se succedants
   * ainsi que toute combinaison de ces trois types d'occurrence.
   * 
   * @param ch
   *          les caracteres proprement dits.
   * @param start
   ...
   * @param data
   *          les valeurs associees a cette cible. En general, elle se presente
   *          sous la forme d'une serie de paires nom/valeur.
   ...
   * probleme non bloque par le parser. Pour ma part je ne pense pas que vous en
   * ayez besoin dans vos traitements.
   * 
   ...
   * @throws SAXException
   *           si la balise ne correspond pas a ce qui est attendu, comme par
   *           exemple non respect d'une dtd.
      ...
      final String name, final Attributes atts) throws SAXException
  {
    ...
    {
      this.ballotBox.setLetter (new Letter (atts.getValue ("name").charAt (0),
          Integer.parseInt (atts.getValue ("value")), Integer.parseInt (atts
              .getValue ("number"))));
    }
  }
