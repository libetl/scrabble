...
public final class DictionaryBuildProcess implements BuildProcess
{
  ...
  private static final Logger LOG = Logger
                                      .getLogger (DictionaryBuildProcess.class);
      ...
      final String filename) throws ClassNotFoundException
  {
    ...
    final String extension = filename
        .substring (indExtension, indExtension + 1).toUpperCase ()
        + filename.substring (indExtension + 1);
    final Class<AbstractDictionaryFactory> cdf = 
      (Class<AbstractDictionaryFactory>) Class
