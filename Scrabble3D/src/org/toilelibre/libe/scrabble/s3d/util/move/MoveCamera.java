...
public final class MoveCamera implements IMoveObject
{
  ...
  public void move (final ICanvas3D sc3d,
      final ITransformGroup stg, final int... params)   
  {
    ...
    if (bp == 1)
    {
      SceneHelper.translate (stg, x / dixMille * mat[0][0], -y / dixMille, x
          / dixMille * mat[2][0]);
    } else if (bp == 2)
    {
    ...
    } else if (bp == trois)
    {
      ...
      SceneHelper.rotate (stg, -roty / centMille, -x / centMille,
          -x / unSixM);
    }
    //System.out.println (st);
  }

  public void moveScene (final ICanvas3D sc3d,
      final ITransformGroup stg, final int bp, final int ax,
      final int px, final int ay, final int py)
  {
    final int dix = 10;
    final int trois = 3;
    final double dixMille = 10000.0;
    ...
    } else if (bp == trois)
    {
      ...
      stg.getTransform (st);
      final double [][] mat = ((AbstractTransform)st).get ();
      SceneHelper.rotate (stg, -roty / centMille * mat[0][0],
          -x / centMille, -roty / centMille * mat[0][2]);
    }
  }
